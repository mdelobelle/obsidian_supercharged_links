...
class SuperchargedLinks extends obsidian.Plugin {
    ...
    registerViewType(viewTypeName, plugin, searchWholeContainer = true, own_class = 'tree-item-inner', parent_class = 'tree-item', searchParent = true) {
    ...
    updateContainer(container, plugin, own_class) {
    ...
    removeFromContainer(container, own_class) {
        const nodes = container.findAll("." + own_class);
        for (let i = 0; i < nodes.length; ++i) {
            const el = nodes[i];
            clearExtraAttributes(el);
    ...
    _watchContainer(viewType, container, plugin, searchWholeContainer, own_class, parent_class, searchParent) {
